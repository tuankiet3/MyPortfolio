  ...
  const projects = [
    ...
    },
    {
      ...
      links: [
        {
          name: "Github",
          url: "https://github.com/nguyenthikimhue2004/CDIO-Dentist-Backend",
        },
      ],
    },
    {
      ...
      links: [
        {
          name: "Github",
          url: "https://github.com/tuankiet3/Integration-System-Backend",
        },
      ],
    },
  ];
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  {project.tech.map((tech, idx) => (
                    <span
                      key={idx}
                      className="bg-dark-700 text-primary-400 px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider border border-primary-500/20"
                    >
                      {tech}
                    </span>
                  ))}
